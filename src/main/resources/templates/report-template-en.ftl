...
<head>
    ...
    <title>Report of measurement results</title>
</head>
<body>
<div class="header">
    ...
    <div class="header-col">
        <h1>Report of measurement results</h1>
    </div>
    <p>
        LIBS analyzer ELANIK
    </p>
    <p>
...
<div class="measurement">
    <div class="info">
        <p><strong>Measurement No. ${m.id}</strong> dated ${m.dateTime}</p>
        <p>Number of measuring points: ${m.pointsNum}</p>
        <p>
            <#if m.comment?? && m.comment?has_content>
                User comment: ${m.comment}
            </#if>
        </p>
    </div>
    ...
    <div class="table-data">
        ...
        <table>
            ...
            <tr>
                ...
                <th>%</th>
                <th>±</th>
                <th><@showStatus text=(m.alloyNames[0]! "Mark 1")/></th>
                <th><@showStatus text=(m.alloyNames[1]! "Mark 2")/></th>
                <th><@showStatus text=(m.alloyNames[2]! "Mark 3")/></th>
            </tr>
            </thead>
            <tbody>
...
<div class="meta">
    <p>The report created: ${creationDateTime}</p>
    <p style="margin-top: 1rem">The report was prepared by: <span class="underline"></span> / <span class="underline"></span> .</p>
</div>
